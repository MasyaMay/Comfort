...
gulp.task('build', ['clean', 'sass', 'css-libs', 'scripts'], function() {
	...
	var buildMailer = gulp.src('app/mailer/phpmailer/*.php') // Переносим mailer/phpmailer в продакшен
	.pipe(gulp.dest('dist/mailer/phpmailer'))

	var buildMailer = gulp.src('app/mailer/smart.php') // Переносим smart.php в продакшен
